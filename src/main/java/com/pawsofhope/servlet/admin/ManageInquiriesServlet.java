...
@WebServlet("/admin/manage-inquiries")
public class ManageInquiriesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/pages/admin/manage-inquiries.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/manage-inquiries");
        } catch (SQLException e) {
            throw new ServletException(e);
        }
    }
